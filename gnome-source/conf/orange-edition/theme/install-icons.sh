...
# Ubuntu Orange Edition — initial Desktop LAF icon installer.
# Source of truth: ubuntu-orange/icons/set-002/*.png
#
...
ICON_ROOT="$ROOT_DIR/ubuntu-orange/icons/set-002"
TARGET_ROOT="${1:-}"
THEME_ROOT="$TARGET_ROOT/usr/share/icons/Ubuntu-Orange"
...
printf 'Ubuntu Orange Edition PNG icon theme installed from set-002: %s\n' "$THEME_ROOT"
