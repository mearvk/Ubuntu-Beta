// Ubuntu Orange Edition Panel extension.
//
// Behavior contract:
...
class StartButton extends PanelMenu.Button {
    _init(extension) {
        ...
        // button; the Orange Edition alignment override below repositions the
        // popup horizontally after the Shell has applied that default.
        super._init(0.0, 'Ubuntu Orange Edition Start', false);

        this._extension = extension;
        this._settings = extension.getSettings();

        this.add_style_class_name('oe-start-button');

        this._icon = new St.Icon({
            style_class: 'oe-start-icon',
            icon_size: 24,
        });
        ...
        // the Orange Edition Start menu items are layered on top of this popup.
        this.menu.addMenuItem(
            new PopupMenu.PopupMenuItem('Ubuntu Orange Edition'));
...
export default class OrangeEditionPanelExtension extends Extension {
    enable() {
