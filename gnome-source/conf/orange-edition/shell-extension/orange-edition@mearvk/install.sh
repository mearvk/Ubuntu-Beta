...
# Ubuntu Orange Edition Panel - GNOME Shell extension installer.
#
# Installs the additive Orange Edition Start button extension into an ISO
...
install -m 0644 -- "$SRC_DIR/schemas/org.gnome.shell.extensions.orange-edition.gschema.xml" \
                   "$EXT_ROOT/schemas/org.gnome.shell.extensions.orange-edition.gschema.xml"
...
printf 'Ubuntu Orange Edition Panel extension installed: %s\n' "$EXT_ROOT"
